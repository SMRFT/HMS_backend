...
_allowed = os.getenv("ALLOWED_HOSTS", "127.0.0.1,localhost,0.0.0.0,192.168.4.38,192.168.3.223")
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': os.getenv("HMS_DB_NAME","HMS"),
...
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'zpid kdqk tekw ixjk')
