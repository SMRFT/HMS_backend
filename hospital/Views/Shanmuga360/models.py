...
class registration360(AuditModel):
    ...
    medicine_bill_number = models.CharField(max_length=50, blank=True, null=True)
    lab_test_bill_number = models.CharField(max_length=50, blank=True, null=True)
    labtestbillnumber = models.CharField(max_length=50, blank=True, null=True)
    ...
    home_care_type       = models.CharField(max_length=100, blank=True, null=True)
    cash_collected_amount = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    transportation_mode   = models.CharField(max_length=100, blank=True, null=True)
    sample_collector      = models.CharField(max_length=255, blank=True, null=True)
